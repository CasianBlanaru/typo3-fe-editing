...
```bash
git clone https://github.com/CasianBlanaru/typo3-fe-editing.git packages/typo3_fe_editing
...
See [`LICENSE`](LICENSE) and the installable package metadata. Pixelcoda FE Editor is an independent implementation. Its workflow review was informed by established TYPO3 frontend-editing projects, including [XIMA TYPO3 Frontend Edit](https://github.com/xima-media/xima-typo3-frontend-edit).
